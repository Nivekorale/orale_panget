<x-app-layout>
    ...
    <div class="py-12 bg-gray-100 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-pink-500 shadow-lg sm:rounded-lg overflow-hidden">
                <div class="p-6">
                    <!-- New User Button -->
                    @if (session('message'))
                        <p>{{ session('message') }}</p>
                    ...
                    <table class="min-w-full table-auto border-collapse">
                        <thead>
                            <tr class="bg-gray-200 dark:bg-red-600 text-left text-sm leading-normal">
                        ...
                        <tbody class="text-gray-700 dark:text-gray-200 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-orange-800">
                                <td class="px-6 py-4">
