<x-app-layout>
    ...
    <div class="py-12 bg-gray-100 dark:bg-pink-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-green-900 shadow-lg sm:rounded-lg overflow-hidden">
                <div class="p-6">
                    <!-- Header -->
                    ...
                    <!-- Table -->
                    <table class="min-w-full border-collapse border border-gray-200 dark:border-gray-700 bg-white dark:bg-purple-800 shadow-md rounded-lg overflow-hidden">
                        <thead>
                            <tr class="bg-gray-200 dark:bg-orange-700 text-left text-gray-600 dark:text-yellow-300 uppercase text-sm leading-normal">
